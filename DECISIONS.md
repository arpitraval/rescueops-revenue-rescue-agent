...
Primary category: Real-Time Search (RTS) API.

Reason: the project is about finding live risk signals across Slack before they become formal CRM or support updates.
...
The demo shows the time from first hidden warning signal to an approved rescue plan.
